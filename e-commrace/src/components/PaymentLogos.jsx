...
export function EasypaisaLogo({ className = "h-8" }) {
  return (
    <div className={`inline-flex items-center gap-2 px-3 py-1.5 bg-[#00A859] rounded-xl text-white shadow-xs border border-[#00924d] select-none hover:scale-105 transition-transform ${className}`}>
      ...
      <div className="flex flex-col leading-none">
        <span className="font-black text-[12px] tracking-tight uppercase">easypaisa</span>
...
// 2. Official JazzCash Logo (Mobilink Microfinance Bank)
export function JazzCashLogo({ className = "h-8" }) {
  return (
    <div className={`inline-flex items-center gap-2 px-3 py-1.5 bg-[#E61C24] rounded-xl text-white shadow-xs border border-[#cc181f] select-none hover:scale-105 transition-transform ${className}`}>
      ...
      <div className="flex flex-col leading-none">
        <span className="font-black text-[12px] tracking-tight">Jazz<span className="text-[#FFCC00]">Cash</span></span>
        <span className="text-[8px] font-medium text-red-100 tracking-wider">Mobilink Bank</span>
      </div>
    </div>
  );
}
...
export function SadaPayLogo({ className = "h-8" }) {
  return (
    <div className={`inline-flex items-center gap-2 px-3 py-1.5 bg-[#000000] rounded-xl text-white shadow-xs border border-neutral-800 select-none hover:scale-105 transition-transform ${className}`}>
      {/* SadaPay Dual Pill Teal/Coral Vector */}
      <div className="flex items-center -space-x-1.5 flex-shrink-0">
        <span className="w-4 h-4 rounded-full bg-[#00D1B2] opacity-90 inline-block shadow-xs"></span>
        <span className="w-4 h-4 rounded-full bg-[#FF5E62] opacity-90 inline-block shadow-xs"></span>
      </div>
      <div className="flex flex-col leading-none">
...
// 4. Official NayaPay Logo (Visa Debit)
export function NayaPayLogo({ className = "h-8" }) {
  return (
    <div className={`inline-flex items-center gap-2 px-3 py-1.5 bg-[#FF6A00] rounded-xl text-white shadow-xs border border-[#e05e00] select-none hover:scale-105 transition-transform ${className}`}>
...
export function VisaLogo({ className = "h-7" }) {
  return (
    <div className={`inline-flex items-center px-2.5 py-1 bg-white rounded-lg border border-gray-200 shadow-xs select-none hover:scale-105 transition-transform ${className}`}>
      <svg width="38" height="13" viewBox="0 0 1000 324" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function MastercardLogo({ className = "h-7" }) {
  return (
    <div className={`inline-flex items-center px-2.5 py-1 bg-[#1A1A1A] rounded-lg border border-neutral-700 shadow-xs select-none hover:scale-105 transition-transform ${className}`}>
      <svg width="30" height="18" viewBox="0 0 100 62" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <span className="ml-1 text-white font-semibold text-[10px] tracking-tight">Mastercard</span>
    </div>
  );
}

// 7. Official PayPak Logo
export function PayPakLogo({ className = "h-7" }) {
  return (
    <div className={`inline-flex items-center gap-1.5 px-2.5 py-1 bg-[#006838] text-white rounded-lg border border-[#00522c] shadow-xs font-bold text-[10px] select-none hover:scale-105 transition-transform ${className}`}>
      <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
...
export function UnionPayLogo({ className = "h-7" }) {
  return (
    <div className={`inline-flex items-center px-2 py-1 bg-white rounded-lg border border-gray-200 shadow-xs select-none hover:scale-105 transition-transform ${className}`}>
      <div className="flex items-center -space-x-1">
        <div className="w-3.5 h-4 bg-[#E21836] rounded-xs transform -skew-x-12"></div>
        <div className="w-3.5 h-4 bg-[#005B9E] rounded-xs transform -skew-x-12"></div>
        <div className="w-3.5 h-4 bg-[#007C64] rounded-xs transform -skew-x-12"></div>
      </div>
...
export function GooglePayLogo({ className = "h-7" }) {
  return (
    <div className={`inline-flex items-center gap-1.5 px-3 py-1 bg-white border border-gray-300 rounded-xl text-gray-800 text-xs font-semibold shadow-xs select-none hover:scale-105 transition-transform ${className}`}>
...
export function ApplePayLogo({ className = "h-7" }) {
  return (
    <div className={`inline-flex items-center gap-1 px-3 py-1 bg-black rounded-xl text-white text-xs font-semibold shadow-xs border border-neutral-800 select-none hover:scale-105 transition-transform ${className}`}>
...
export function BankTransferLogos({ className = "" }) {
  return (
    <div className={`inline-flex items-center gap-2 flex-wrap ${className}`}>
      {/* Meezan Bank */}
      <div className="inline-flex items-center gap-1 px-2.5 py-1 bg-[#4A154B] text-white rounded-lg shadow-xs text-[10px] font-bold border border-[#3b103c] select-none hover:scale-105 transition-transform">
        <span className="w-2 h-2 rounded-full bg-[#D4AF37] inline-block"></span>
        <span>Meezan Bank</span>
      </div>

      {/* HBL (Habib Bank) */}
      <div className="inline-flex items-center gap-1 px-2.5 py-1 bg-[#008269] text-white rounded-lg shadow-xs text-[10px] font-bold border border-[#006854] select-none hover:scale-105 transition-transform">
        <span className="font-serif font-black">HBL</span>
      </div>

      {/* Bank Alfalah */}
      <div className="inline-flex items-center gap-1 px-2.5 py-1 bg-[#BF1E2E] text-white rounded-lg shadow-xs text-[10px] font-bold border border-[#991825] select-none hover:scale-105 transition-transform">
        <span>Alfalah</span>
      </div>

      {/* Raast / 1-Link Instant IBFT */}
      <div className="inline-flex items-center gap-1 px-2.5 py-1 bg-[#0B4F26] text-white rounded-lg shadow-xs text-[9px] font-bold border border-[#083b1c] select-none hover:scale-105 transition-transform">
...
export function CODLogo({ className = "" }) {
  return (
    <div className={`inline-flex items-center gap-2 px-3 py-1.5 bg-[#141410] border border-[#d4af37]/40 rounded-xl text-white shadow-xs select-none hover:scale-105 transition-transform ${className}`}>
      <div className="w-5 h-5 rounded-lg bg-[#d4af37]/20 border border-[#d4af37]/40 flex items-center justify-center text-[#f7e08b] flex-shrink-0">
      ...
      <div className="flex flex-col leading-none">
        ...
        <span className="text-[8px] font-mono text-gray-400">Pay at Doorstep</span>
      </div>
    </div>
  );
}

// 14. Luxury Multi-Gateway Showcase Bar for Footers, Checkout & Product Pages
export function PaymentSuiteShowcase({ className = "" }) {
  return (
    <div className={`p-4 bg-white/80 backdrop-blur-md rounded-2xl border border-gray-200/80 shadow-xs space-y-3 ${className}`}>
      <div className="flex items-center justify-between border-b border-gray-100 pb-2">
        <div className="flex items-center gap-1.5 text-xs font-bold text-gray-900">
          <Lock size={13} className="text-emerald-600" />
          <span>256-Bit SSL Encrypted Gateways</span>
        </div>
        <div className="flex items-center gap-1 text-[10px] font-mono text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-full font-bold">
          <ShieldCheck size={11} /> PCI-DSS Level 1
        </div>
      </div>
