  ...
  return (
    <div className="p-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
          <h1 className="font-display text-4xl font-700 text-white">
            Products
          </h1>
      ...
      <div className="bg-[#0a0a0a] border border-[#1e1e1e] rounded-3xl p-6 mb-8 flex flex-col md:flex-row gap-4">
        <div className="relative flex-1">
          <Search
            className="absolute left-4 top-1/2 -translate-y-1/2 text-[#787878]"
            size={20}
          />
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-[#1e1e1e]">
                <th className="px-6 py-5 text-left text-xs font-medium text-[#787878] uppercase tracking-wider">
                  Product
                </th>
                ...
                <th className="px-6 py-5 text-right text-xs font-medium text-[#787878] uppercase tracking-wider">
                  Actions
                </th>
              </tr>
            </thead>
